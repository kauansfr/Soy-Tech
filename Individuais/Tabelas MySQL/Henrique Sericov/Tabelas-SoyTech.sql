...
Dados_De_Umidade varchar(4) not null,
Ultima_Leitura datetime not null
);
...
(default,'1','1','46%','Atenção! Umidade Media!','2024-03-11 06:30:00'),
(default,'2','1','83%','Umidade Ideal!','2024-03-10 19:45:30'),
(default,'3','1','30%','ALERTA! Umidade Baixa!','2024-03-09 10:22:47'),
(default,'4','1','68%','Atenção! Umidade Media!','2024-03-11 21:57:23'),
(default,'5','1','72%','Umidade Ideal!','2024-03-13 17:34:32'),
(default,'6','1','94%','Umidade Ideal!','2024-03-10 02:58:00'),
(default,'7','1','15%','ALERTA! Umidade Baixa!','2024-03-08 03:20:15'),
(default,'8','1','25%','ALERTA! Umidade Baixa!','2024-03-07 14:45:21'),
(default,'9','1','57%','Atenção! Umidade Media!','2024-03-10 11:55:40'),
(default,'10','1','49%','Atenção! Umidade Media!','2024-03-14 15:30:00');

-- ----------------------------------------------------------------------------------------------------------------------------------------------------

-- ------------------------------------------------------- Insert Sensores ----------------------------------------------------------------------------
insert into Sensor Values
(default,'1','46%', '2024-03-11 06:30:00'),
(default,'2','83%', '2024-03-10 19:45:30'),
(default,'3','30%','2024-03-09 10:22:47'),
(default,'4','68%','2024-03-11 21:57:23'),
(default,'5','72%','2024-03-13 17:34:32'),
(default,'6','94%','2024-03-10 02:58:00'),
(default,'7','15%','2024-03-08 03:20:15'),
(default,'8','25%','2024-03-07 14:45:21'),
(default,'9','57%','2024-03-10 11:55:40'),
(default,'10','49%','2024-03-14 15:30:00');
...
SELECT concat('Olá ',nome, "! Ficamos felizes em saber que contratou nossos serviços! Mandaremos avisos recorrentes para lhe manter informado para o email de contato fornecido que é o ",Email_para_contato) FROM Cliente
WHERE IdCliente = 4;
...
SELECT concat('A Fazenda com o nome de ', Nome_Fazenda, ' Localizada no CEP Rural ', CEP_RURAL, ' Possui ', Qnt_Hectares, ' Hectares, Portanto serão Necessarios 55 sensores para suprir a demanda de monitoramento da fazenda.') FROM Fazenda
WHERE IdFazenda = 1;
...
SELECT concat(Estado_Hectare,' A Umidade do Hectare se encontra em ',Umidade,'. A Ultima Leitura de Umidade desse Hectare Foi realizada em ', Ultima_Leitura) FROM Hectare
WHERE IdHectare = 9;
